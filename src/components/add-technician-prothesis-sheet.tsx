...
export default function add_technician_prothesis_sheet() {
    const router = useRouter();
    const utils = api.useUtils();
    const { isOpen, patientId: contextPatientId, dentistId: contextDentistId, closeSheet } = useProsthesisSheet();
    ...
    const { data: existingDentalWorks } = api.laboratoryTechnician.dentalWork.getAll.useQuery(
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <SelectPatient {...field} userType="technician" />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
