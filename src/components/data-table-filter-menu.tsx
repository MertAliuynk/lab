		...
		<div className="flex flex-wrap items-center gap-2">
			...
			<Popover open={open} onOpenChange={onOpenChange}>
				<PopoverTrigger asChild>
					<Button
						aria-label="Filtre komut menüsünü aç"
						variant="outline"
					...
					>
						<ListFilter />
						{filters.length > 0 ? null : "Filtrele"}
					</Button>
				</PopoverTrigger>
				<PopoverContent
					align={align}
				...
				>
					<Command loop className="[&_[cmdk-input-wrapper]_svg]:hidden">
						<CommandInput
							ref={inputRef}
							placeholder={
								selectedColumn ? (selectedColumn.columnDef.meta?.label ?? selectedColumn.id) : "Alanlarda ara..."
							}
							value={inputValue}
						...
						<CommandList>
							{selectedColumn ? (
								<>
									{selectedColumn.columnDef.meta?.options && <CommandEmpty>Seçenek bulunamadı.</CommandEmpty>}
									<FilterValueSelector
